...
const ImpactView = {
    ...
    _renderClaudeTable(data, playerRoles) {
        ...
        html += '<colgroup><col style="width:21%"><col style="width:13%"><col style="width:9%"><col style="width:12%"><col style="width:14%"><col style="width:15%"><col style="width:16%"></colgroup>';
        html += '<thead><tr>';
